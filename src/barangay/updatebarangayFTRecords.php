        ...
        <form action="#" method="post" class="bg-[#f4f4f4] px-16 py-2">
            <h1 class="text-2xl text-center font-semibold text-orange-200 mb-5">Update</h1>
                ...
                <div class="relative flex items-center">
                    <input class="rounded-md p-2 pl-6 mb-8 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800" type="text" name="clFtYear" placeholder="Update Year" required>
                </div>

                <label for="clFtPercent" class="ml-4 text-gray-600">Percent</label>
                <div class="relative flex items-center">
                    <input class="rounded-md p-2 pl-6 mb-8 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800" type="text" name="clFtPercent" placeholder="Update Percent" required>
                </div>

            <input type="submit" value="save" name="updateFTRecordBtn"
