    ...
    <div class="flex">
        ...
        <div class="h-full ml-72 px-12 py-6 w-full grid justify-center">
            ...
            <form method="POST">
                ...
                <?php
                    echo'<br>';
                    echo'<label for="tbItPercent">Income Threshold Percentage</label><br>';
                    echo'<input type="text" name="tbItPercent" 
                            ...
                            value="'.$row['tbItPercent'].'">';
                    
                    echo' <br>';
                    echo'<label for="clITYear">Year</label><br>';
                    echo'<input type="text" name="clITYear" 
                            class="rounded-md p-2 pl-6 mb-3 border border-solid border-gray-300 w-96 focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                            value="'.$row['clITYear'].'">';
                    
                    echo'<br><button type="submit" name="AddRecord" 
                            ...
                            formaction="../crud/tbincomethresholdUpdateRecord.php?tbItID='.$tbItID.'"> Update Record 
                        </button>';
