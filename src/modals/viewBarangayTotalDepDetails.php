<div class="add-modal fixed w-[500px] top-[10%] right-[25%] text-md ">
        <?php 
            if(isset($_POST['TdIDbtn'])){ 
                ...
                $totalDepDetails = mysqli_query($connectdb,"SELECT td.clTdID, td.clTdPercent, td.clTdYear, td.clBrID, td.clFtID, td.clItID, td.clUnID,
        ...
        <div class="bg-[#fdfbfb] px-16 py-2 shadow-md shadow-gray-500">
            ...
            <?php 
                while($row = $totalDepDetails->fetch_assoc()) {
                    echo' 
