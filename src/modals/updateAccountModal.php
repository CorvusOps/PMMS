<div class="update-modal hidden w-[500px] h-full top-0 text-md my-4 right-[20%]">

        <form action="../crud/tbusersEditAccount.php" method="post" class="bg-[#f4f4f4] px-16 py-2 shadow-md shadow-gray-500">

            <button type="reset" onclick="closeModal('.update-modal')">
                <iconify-icon icon="carbon:close" width="25" id="close" class="absolute right-[20px] top-[10px] cursor-pointer"></iconify-icon>
            </button>

            <h1 class="text-2xl text-center font-semibold text-orange-200 mb-3">Update User Details</h1>
            ...
            <div class="relative flex items-center">
                <input class="rounded-md p-2 pl-8 mb-3 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                    type="text" name="clUrUsername" placeholder="Update Username" required>
            </div>
            <label for="password" class="ml-4 text-gray-600">Password</label>
            <div class="relative flex items-center">
                <input class="rounded-md p-2 pl-8 mb-3 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                    type="password" name="clUrPassword" placeholder="Update Password" required>
            </div>
            ...
            <div class="relative flex items-center">
                <input class="rounded-md p-2 pl-8 mb-3 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                    type="text" name="clUrName" placeholder="Update Name" required>
            </div>

            <label for="contactNum" class="ml-4 text-gray-600">Contact Number</label>
            <div class="relative flex items-center">
                <input class="rounded-md p-2 pl-8 mb-3 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                    type="text" name="clUrContactNum" placeholder="Update Contact number" required>
            </div>

            <label for="email" class="ml-4 text-gray-600">Email address</label>
            <div class="relative flex items-center">
                <input class="rounded-md p-2 pl-8 mb-3 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800"
                    type="text" name="clUremail" placeholder="Update Email" required>
            </div>

            <label for="userRole" class="ml-4 text-gray-600">Occupation</label>
            <select value="" name="clUrUserRole" class="rounded-md p-2 pl-8 mb-4 border border-solid border-gray-300 w-full focus:outline-none text-gray-500 focus:border-blue-600 focus:text-gray-800">
            ...
            <input type="submit" value="save" name="updateUserBtn"
