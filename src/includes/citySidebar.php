<nav class="fixed h-screen w-72 bg-white px-2 py-8">
    ...
    <div id="userDisp" class="flex gap-4 items-center ml-6 mb-8 px-4">
        ...
        <h2 id="user-info" class="text-2xl text-orange-200 font-semibold">Juan</h2>
    </div>
    ...
    <ul class="mx-6">
        ...
        <li class="menu hover:bg-orange-200 px-6 py-2 rounded-xl mt-5 mb-2 text-orange-200 hover:text-white">
            <a href="cityDashboard.php" class="flex items-center gap-4">
        ...
        <li class="menu hover:bg-orange-200 px-4 py-2 rounded-xl mb-2 text-orange-200 hover:text-white">
            <a href="cityBarangays.php" class="flex items-center gap-4">    
        ...
        <li class="menu flex items-center hover:bg-orange-200 rounded-xl text-orange-200 hover:text-white">
            <a href="cityRecords.php" class="flex items-center gap-5 pl-2 py-2 ">
